//
//  NSRTCChatTabBarContactsItemView.m
//  NSRTCSDK_Example
//
...
@interface NSRTCChatTabBarContactsItemView ()
...
@end
@implementation NSRTCChatTabBarContactsItemView
...
- (void)setupContentLayer {
    ...
    else if (self.orientation == NSRTCChatTabBarLeft) {
