...
@interface NSRTCChatImageBrowserCell () <UIScrollViewDelegate>

@property (nonatomic, strong) UIScrollView *imageScrollView;
@property (nonatomic, strong) UIImageView *imageView;

@end
@implementation NSRTCChatImageBrowserCell
...
- (void)setImageModel:(NSRTCChatImageBrowserModel *)imageModel {
...
//            NSString* strUrl =
//            //[NSString stringWithFormat:@"%@/%@",baseURL,imageModel.thumRemotePath];
//            [baseURL stringByAppendingPathComponent:imageModel.thumRemotePath];
