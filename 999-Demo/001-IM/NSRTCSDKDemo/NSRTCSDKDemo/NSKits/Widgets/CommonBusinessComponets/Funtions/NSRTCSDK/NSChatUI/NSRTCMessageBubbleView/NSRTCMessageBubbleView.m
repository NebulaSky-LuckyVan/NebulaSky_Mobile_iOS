...
@interface NSRTCMessageBubbleView () {
...
@end
@implementation NSRTCMessageBubbleView
+ (void)initialize {
    NSRTCMessageBubbleView *view = [self appearance];
...
- (void)createUI {
    ...
    _bubbleImage.image = [UIImage imageNamed:_isSender ? @"qp3" : @"qp2"];
...
- (void)setMessage:(NSRTCMessage *)message {
    _message = message;
