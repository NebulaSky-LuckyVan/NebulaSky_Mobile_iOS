//
//  MBPLauncherMicroApp2AppDelegate.m
//  DobulePlatformApplications
//
//  Created by VanZhang on 2020/11/19.
//

#import "MBPLauncherMicroApp2AppDelegate.h"
 

#import "MBPTabBarController.h"

@interface MBPLauncherMicroApp2AppDelegate ()<NSMicroApplicationDelegate>

@property (nonatomic, strong) MBPTabBarController* rootVC;

@end

@implementation MBPLauncherMicroApp2AppDelegate
...
- (id)init
{
   ...
   if (self) {
       ...
       UIViewController* tab3ViewController = [[NSViewController alloc] init];
       UIViewController* tab4ViewController = [[NSViewController alloc] init];
